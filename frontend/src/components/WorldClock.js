...
const AnalogClockHands = ({ timeZone }) => {
  ...
  return (
    <div className="relative w-full h-full">
      {/* Hour Hand */}
      <div 
        className="absolute w-1.5 h-10 bg-blue-700 origin-bottom left-1/2 bottom-1/2 -ml-0.5 rounded-full"
        style={{
      ...
      {/* Minute Hand */}
      <div 
        className="absolute w-1 h-14 bg-blue-500 origin-bottom left-1/2 bottom-1/2 -ml-px rounded-full"
        style={{
      ...
      {/* Second Hand */}
      <div 
        className="absolute w-0.5 h-16 bg-blue-400 origin-bottom left-1/2 bottom-1/2 -ml-px"
        style={{
      ...
      />
      {/* Center dot */}
      <div className="absolute w-2 h-2 bg-blue-700 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-2 border-blue-200 z-10" />
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="text-center mb-8">
        ...
        <div className="mt-2">
          <span className="bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded-full inline-block">
      ...
      <div className="flex flex-wrap justify-center gap-10">
        {timeZones.map(({ id, name, timeZone }) => (
          <div key={id} className="flex flex-col items-center mx-4">
            <div className="relative w-32 h-32 bg-white rounded-full shadow-md border-2 border-blue-300 p-1">
              {/* Clock face */}
            ...
            {/* Digital Time */}
            <div className="mt-2 text-sm font-mono text-blue-700 font-medium">
            ...
            <h3 className="font-semibold text-blue-800 text-base mt-2">{name}</h3>
